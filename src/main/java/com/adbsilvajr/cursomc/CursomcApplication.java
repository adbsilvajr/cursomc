package com.adbsilvajr.cursomc;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat2 = new Categoria(null, "Escritorio2");
		Categoria cat3 = new Categoria(null, "Informatica3");
		Categoria cat4 = new Categoria(null, "Escritorio4");
		Categoria cat5 = new Categoria(null, "Informatica5");
		Categoria cat6 = new Categoria(null, "Escritorio6");
		Categoria cat7 = new Categoria(null, "Informatica7");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "234234", TipoCliente.PESSOAFISICA);
