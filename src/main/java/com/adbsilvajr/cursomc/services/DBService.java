...
import com.adbsilvajr.cursomc.domain.PagamentoComCartao;
...
import com.adbsilvajr.cursomc.repositories.EstadoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "adbsilvajr@gmail.com", "234234", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("123123", "321321"));

		Cliente cli2 = new Cliente(null, "ADILSON Silva", "teste@gmail.com", "234234", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("123123", "321321"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Teste", "111", "apt1", "Jardin1", "11111", cli1, c1);
		Endereco e2 = new Endereco(null, "Rua Teste2", "222", "apt2", "Jardin2", "22222", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Teste3", "3", "apt3", "Jardi3n3", "33333", cli2, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("30/09/2017 10:32"), cli1, e1);
