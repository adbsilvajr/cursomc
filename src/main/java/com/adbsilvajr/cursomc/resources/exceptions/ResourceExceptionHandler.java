package com.adbsilvajr.cursomc.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		ValidationError err = new ValidationError(HttpStatus.BAD_REQUEST.value(), "Erro de Valicao",
				System.currentTimeMillis(), "Validacao");
